<template>
  <el-container class="user-layout">
    ...
    <el-aside :width="isCollapsed ? '64px' : '220px'" class="user-sidebar" :class="{ 'mobile-sidebar': isMobile, 'mobile-show': isMobile && !isCollapsed }">
...
import { Odometer, Picture, Lock, Fold, Expand, Sunny, Moon, Monitor } from '@element-plus/icons-vue'
...
const menuItems = [
  { path: '/user/dashboard', icon: Odometer, label: '我的图库' },
  { path: '/user/images', icon: Picture, label: '图片管理' },
